"""
Pairing phrase word list for device code authentication flow.

This module contains the same word list as the server (web/lib/pairPhrases.ts).
Used by the agent for local validation of pairing phrases.

The word list must stay in sync between agent and server.
"""

WORD_LIST = [
    'able', 'about', 'above', 'absent', 'absorb', 'abstract', 'absurd', 'abuse',
    'access', 'acid', 'across', 'act', 'action', 'actor', 'adapt', 'add',
    'addict', 'address', 'adjust', 'admit', 'adult', 'advance', 'advice', 'aerial',
    'afford', 'afraid', 'again', 'agent', 'agree', 'ahead', 'aim', 'air',
    'airport', 'aisle', 'alarm', 'album', 'alert', 'alien', 'align', 'allow',
    'almost', 'alone', 'alpha', 'already', 'also', 'alter', 'always', 'amateur',
    'amazing', 'among', 'amount', 'anchor', 'ancient', 'angel', 'anger', 'angle',
    'angry', 'animal', 'ankle', 'annual', 'another', 'answer', 'antenna', 'antique',
    'anxiety', 'any', 'apart', 'apology', 'apple', 'approve', 'april', 'arch',
    ...
    'burden', 'burger', 'burst', 'bus', 'busy', 'butter', 'buyer', 'buzz',
    ...
    'cat', 'catalog', 'catch', 'cattle', 'caught', 'cause', 'caution', 'cave',
    ...
    'choice', 'choose', 'chronic', 'chunk', 'circle', 'citizen', 'city', 'civil',
    'claim', 'clap', 'clarify', 'claw', 'clay', 'clean', 'clever', 'click',
    ...
    'damp', 'dance', 'danger', 'daring', 'dash', 'dawn', 'day', 'deal',
    ...
    'deputy', 'derive', 'describe', 'desert', 'design', 'desk', 'despair', 'detail',
    ...
    'display', 'distance', 'divert', 'divide', 'dizzy', 'doctor', 'document', 'dog',
    ...
    'emotion', 'employ', 'empower', 'empty', 'enable', 'endless', 'endorse', 'enemy',
    'energy', 'enforce', 'engage', 'engine', 'enhance', 'enjoy', 'enlist', 'enough',
    'enrich', 'enroll', 'ensure', 'enter', 'entire', 'entry', 'envelope', 'episode',
    'equal', 'equip', 'era', 'erase', 'erode', 'erosion', 'error', 'erupt',
    'escape', 'essay', 'essence', 'estate', 'eternal', 'evoke', 'evolve', 'exact',
    ...
    'gadget', 'gain', 'galaxy', 'gallery', 'game', 'gap', 'garage', 'garden',
    ...
    'hand', 'happy', 'harbor', 'hard', 'harvest', 'hat', 'hawk', 'hazard',
    'head', 'health', 'heart', 'heavy', 'hedgehog', 'height', 'hello', 'helmet',
    'help', 'hero', 'hip', 'hire', 'history', 'hobby', 'hockey', 'hold',
    ...
    'infant', 'inflict', 'inform', 'inhale', 'inherit', 'initial', 'inject', 'inmate',
    ...
    'just', 'kangaroo', 'keen', 'keep', 'kernel', 'key', 'kick', 'kid',
    ...
    'legal', 'legend', 'leisure', 'lemon', 'length', 'lens', 'leopard', 'lesson',
    'letter', 'level', 'liberty', 'library', 'license', 'life', 'lift', 'light',
    ...
    'meadow', 'mean', 'measure', 'meat', 'mechanic', 'media', 'melody', 'melt',
    ...
    'noise', 'nominee', 'normal', 'north', 'nose', 'notable', 'nothing', 'notice',
    ...
    'raft', 'rage', 'rail', 'rain', 'raise', 'rally', 'ramp', 'ranch',
    'random', 'range', 'rapid', 'rare', 'rate', 'rather', 'raven', 'raw',
    'razor', 'ready', 'real', 'reason', 'rebel', 'rebuild', 'recall', 'receive',
    'recipe', 'record', 'recycle', 'reduce', 'reflect', 'reform', 'region', 'regret',
    ...
    'save', 'say', 'scale', 'scan', 'scatter', 'scene', 'scheme', 'school',
    ...
    'swamp', 'swap', 'swarm', 'sweet', 'swim', 'swing', 'switch', 'sword',
    ...
    'toddler', 'toe', 'together', 'token', 'tomato', 'tomorrow', 'tone', 'tongue',
...
# Pre-compute set for O(1) validation
_WORD_SET = frozenset(WORD_LIST)


def is_valid_pair_phrase(phrase: str) -> bool:
    """Validate that a string is a well-formed pairing phrase (3 words from the list)."""
    words = phrase.lower().strip().split('-')
    if len(words) != 3:
        return False
    return all(w in _WORD_SET for w in words)


def normalize_pair_phrase(phrase: str) -> str | None:
    """Normalize a pairing phrase (lowercase, trim). Returns None if invalid."""
    normalized = phrase.lower().strip()
    if not is_valid_pair_phrase(normalized):
        return None
    return normalized
