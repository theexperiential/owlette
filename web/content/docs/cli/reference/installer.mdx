...
Agent installer binary management for the platform-wide catalog of `Owlette-Installer-vX.Y.Z.exe` binaries that new agents pull during pairing. This is not the per-site classic deploy surface; see [`deploy`](/docs/cli/reference/deploy).
