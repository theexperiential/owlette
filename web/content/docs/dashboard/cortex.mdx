...
There is exactly one place an LLM key lives: your own account settings. Every Cortex feature — chat, talons, visual checks, autonomous investigations — resolves a key belonging to a specific person.
...
| autonomous Cortex | the **site owner** |
