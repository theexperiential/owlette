...
| **admin** | none | site-scoped write access on assigned sites, including machine commands/configuration, deployments, roosts, talons, site webhooks, logs, and site-member management |
