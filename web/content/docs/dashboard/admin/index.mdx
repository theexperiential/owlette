...
| `MACHINE_VIEW` | yes | yes | yes | assigned sites / all sites |
| `MACHINE_CONFIG_WRITE` | no | yes | yes | assigned sites / all sites |
| `MACHINE_REMOVE` | no | yes | yes | assigned sites / all sites |
...
| `TALON_MANAGE` | no | yes | yes | assigned sites / all sites |
| `AGENT_TOKEN_REVOKE` | no | yes | yes | assigned sites / all sites |
