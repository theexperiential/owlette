---
title: "deployments"
description: "Deploy Windows installers to one or many machines. owlette creates a tracked deployment record, fans out install_software commands, and reconciles per-machine progress as agents report back."
---
...
![deployments list](/docs-screens/deployments.png)
...
<Callout type="idea" title={"Testing flags"}>
