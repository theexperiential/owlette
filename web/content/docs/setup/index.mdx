...
owlette is licensed under [FSL-1.1-Apache-2.0](https://github.com/theexperiential/owlette/blob/main/LICENSE). The license grants use, copying, modification, derivative works, public performance, public display, and redistribution for any "Permitted Purpose", which means any purpose other than a "Competing Use".
...
4. [Web Deployment](/docs/setup/web-deployment) - deploy the Next.js dashboard to Railway or another Node.js 20 host and attach the required environment variables.
