...
See [environment variables](/docs/setup/environment-variables) and [web deployment](/docs/setup/web-deployment) for the full production checklist, including session, email, rate-limit, cron, Cortex, and R2 variables.
