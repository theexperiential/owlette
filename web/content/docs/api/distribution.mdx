---
title: "SDK and CLI distribution"
description: "External public launch requires installable SDK and CLI packages. Developer preview can proceed without registry publication, but external launch should not."
---
