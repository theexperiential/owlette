---
title: "Distribution"
description: "The public API distribution surface is the project-distribution endpoints; the package release checklist below is retained as launch status, not endpoint reference."
---
