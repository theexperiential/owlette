---
title: "sdk workflow examples"
description: "small executable SDK examples live in the node and python SDK example folders and run against a dev or staging tenant with explicit env vars."
---
...
For CI/CD examples, see [ci/cd with GitHub Actions](/docs/api/examples/ci-cd-github-actions).
