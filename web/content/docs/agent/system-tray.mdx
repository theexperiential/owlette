---
title: "system tray"
description: "The owlette system tray icon provides at-a-glance status and quick access to common actions. It runs as a separate process from the service, using pystray for the tray icon and owlette_tray.py for logic."
---
...
|-------|--------------|---------------|
| **connected** | steady amber glow | service running and connected to the cloud — everything healthy |
| **connection issues** | dim, muted glow | service running but not reaching the cloud (offline, or still starting up) |
| **error** | pulsing red | service stopped or crashed, a health-probe failure, or monitoring disabled |
