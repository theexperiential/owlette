...
See [Cortex tools reference](/docs/reference/cortex-tools) for the current tool list.
...
3. Firestore commands are processed by the Firebase command listener; the 5-second service loop handles process monitoring, Cortex IPC, Firebase enable/disable checks, and periodic maintenance
