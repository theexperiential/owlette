/**
 * Published-surface back-compat alias: /api/sites/{siteId}/machines/{machineId}/cortex-enabled → /api/sites/{siteId}/machines/{machineId}/hoot-enabled.
 *
...
export { PATCH } from '@/app/api/sites/[siteId]/machines/[machineId]/hoot-enabled/route';
