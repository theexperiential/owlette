...
5. Before external public launch, confirm the [status page and uptime checks](status-uptime.md), [load testing and SLOs](load-testing.md), [SDK/CLI distribution gate](distribution.md), [launch assets](launch-assets.md), and [launch runbook](launch-runbook.md).
