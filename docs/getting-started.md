...
3. A console window displays a **pairing phrase** (3 random words), the authorization URL, and the prompt **"press Enter to open the pairing page in your browser"**
4. Press Enter only if you want to open the local browser, then select a site and click **"Authorize"**
