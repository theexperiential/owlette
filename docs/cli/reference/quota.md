...
`quota` inspects a site's storage + bandwidth usage against its tier limit. site-scoped: both verbs require `--site <siteId>`. read-only — quotas are managed server-side by the billing layer. tier: `[ready]` for both verbs.
...
- **related**: [overview](../overview.md) (json envelope), [site](site.md) (find your site ids), [roost](roost.md) (the main thing eating your storage)
